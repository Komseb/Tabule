...
\begin{center}
    %\includegraphics[width=0.4\linewidth]{logo.png} \\[2cm]
    
    {\Huge \textbf{Příprava slavnostní tabule pro 2 osoby}} \\[1cm]
    {\Large \textbf{Slavnostní hostina v rámci Křtin}} \\[2cm]
    
    {\Large \textbf{Tereza Kováčová}} \\[0.5cm]
    {\large Žákyně 3. ročníku} \\
    {\large Soukromá střední a odborná škola hotelnictví a cestovního ruchu} \\[3cm]
    
    {\large Datum: 15.1.2026}
\end{center}
...
Nejčastěji jde o 3 až 4 chodový banketní způsob obsluhy s precizní synchronizací vydávání pokrmů z kuchyně a perfektním servisem u stolu.

\subsection*{Nároky}
Kvalitní inventář, látkové ubrousky a decentní květinová výzdoba. Prostírání musí být elegantní a čisté, bílé nebo pastelové barvy, použití křesťanské symboliky. Dárkový stůl musí být předpřipraven pro dary.

\subsection*{Pokrmy}
Lehčí slavnostní menu, které zahrnuje například telecí, drůbeží, ryby a kvalitní suroviny, estetická příprava.
