...
\begin{enumerate}
    ...
    \item Konfetka
    \item Sklenice na pinot Noir
    \item Sklenice na pinot Veltínské
    \item Sklenice na Mozart Chocolate coffee
...
\begin{itemize}
    ...
    \item[-] \textbf{Servis studeného předkrmu} Před samotným servisem je důležité připravit všechny suroviny a pokrmy. Studené předkrmy se obvykle podávají na mísách, které jsou obloženy dezertním talířem. Předkrm, který je v menu budeme překládat hostovi z leva s mísou v levé ruce pomocí překládacího příboru. Chef de rang nabídne hostům nealkoholický nápoj, v tomto případě karafu s vodou, pomerančem a mátou.
    ...
    \item[-] \textbf{Servis moučníku} Chef de rang neboli vrchní číšník přinese z kuchyně na dezertním talířku moučník v tomto případě vanilkové cupcakes. Someliér přinese nápoj, v tomto případě Mozart Chocolate coffee. 
