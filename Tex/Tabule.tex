...
\begin{itemize}
    ...
    \item[-] \textbf{Servis studeného předkrmu} Před samotným servisem je důležité připravit všechny suroviny a pokrmy. Studené předkrmy se obvykle podávají na mísách, které jsou obloženy dezertním talířem. Předkrm, který je v menu budeme překládat hostovi z leva s mísou v levé ruce pomocí překládacího příboru. Chef de rang nabídne hostům nealkoholický nápoj jako je třeba minerální voda nebo nealkoholické pivo.
    \item[-] \textbf{Servis teplého předkrmu} Po polévce z debarasujeme použitý inventář. Sommeliér hostům nalije bílé víno z láhve do předem založené sklenice. Teplota bílého vína konkrétně Veletínského zeleného by měla být 9 - 11°C a nalévá se z pravé strany hosta.
    ...
    \item[-] \textbf{Servis hlavního chodu} Číšník provede debaras po konzumaci teplého předkrmu včetně sklenice na bílé víno. Sommeliér přinese červené víno v tomto případě Pinot Noir. Toto červené víno se servíruje při teplotě 14 - 16 °C do sklenice na červené víno typu ,, balon” z pravé strany.
    \item[-] \textbf{Servis moučníku} Chef de rang neboli vrchní číšník přinese z kuchyně na dezertním talířku moučník v tomto případě vanilkové cupcakes. 
    \item[-] \textbf{Servis kávy} Po debarasu celého inventáře, který zahrnuje dezertní talíře, dezertní vidličku a také klubový talíř. Přijde sommeliér a založí šálek s podšálkem na kávu. Sommeliér z konvičky naleje hostům z pravé strany kávu. \\Espresso - 30ml.
...
\begin{itemize}
    \item[] 11:00: Hosti uvítání a usazování
    \item[] 11:05: Servis aperitívu a amuse-bouche
    \item[] 11:25: Servis nealkoholického nápoje
    \item[] 11:30: Servis studeného předkrmu    
    \item[] 11:45: Servis polévky
    \item[] 12:05: Servis bílého vína
    \item[] 12:15: Servis teplého předkrmu
    \item[] 12:35: Servis červeného vína
    \item[] 12:45: Servis hlavního chodu
    \item[] 13:45: Servis dezertu
    \item[] 14:00: Servis kávy a digestivu
    \item[] 14:15: Zábava
    \item[] 15:00: Ukončení akce a rozloučení s hosty
\end{itemize}
\newpage
